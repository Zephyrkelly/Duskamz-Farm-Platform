...
<head>
  ...
  <style>
    ...
    .hero { background-color:#0C2C47; color:#F7E7CE; text-align:center; padding:80px 20px; }
    .hero h2 { font-size:2.5em; color:#C8E3D4; }
    .hero p { font-size:1.2em; margin-top:10px; }
    .featured { background-color:#C8E3D4; padding:50px 20px; text-align:center; }
    .featured h3 { color:#0C3B2E; font-size:2em; margin-bottom:30px; }
    footer { background-color:#0C3B2E; color:#F7E7CE; text-align:center; padding:15px; margin-top:40px; }
  </style>
</head>
<body>
  <header>
  ...
  <section class="hero">
    ...
    <a href="product.php" class="btn btn-success mt-3">Browse Products</a>
  </section>
